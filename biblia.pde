class Biblia {
  ...
  FBox cuadrado;
  float velocidad = 4; // Velocidad de movimiento
  ...
  Biblia() {
    ...
    cuadrado.setPosition(width / 2 + 180, height + cuadrado.getHeight() / 2 -250); // Iniciar desde abajo
    ...
    targetY = height / 2-80; // Mover hacia la mitad de la pantalla
  }
